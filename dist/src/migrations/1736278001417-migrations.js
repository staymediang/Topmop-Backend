...
exports.Migrations1736278001417 = void 0;
class Migrations1736278001417 {
    constructor() {
        this.name = 'Migrations1736278001417';
    }
    async up(queryRunner) {
        await queryRunner.query(`CREATE TABLE "service" ("id" SERIAL NOT NULL, "title" character varying(100) NOT NULL, "description" text NOT NULL, "imageUrl" character varying, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "createdById" uuid, CONSTRAINT "PK_85a21558c006647cd76fdce044b" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "bookings" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "frequency" character varying(50) NOT NULL, "hoursRequired" integer NOT NULL, "preferredDay" character varying(20), "preferredTime" character varying(20), "meetCleanerFirst" boolean NOT NULL DEFAULT false, "cleaningStartDate" date, "needsIroning" boolean NOT NULL DEFAULT false, "accessInstructions" text, "additionalInfo" text, "referralSource" character varying(100), "firstName" character varying(100), "lastName" character varying(100), "contactNumber" character varying(15), "email" character varying(100), "address" text, "city" character varying(50), "postalCode" character varying(20), "paymentType" character varying(20) NOT NULL, "amount" numeric(10,2) NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "userId" uuid NOT NULL, CONSTRAINT "PK_bee6805982cc1e248e94ce94957" PRIMARY KEY ("id"))`);
...
exports.Migrations1736278001417 = Migrations1736278001417;
