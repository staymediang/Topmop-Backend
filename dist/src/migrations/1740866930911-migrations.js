...
exports.Migrations1740866930911 = void 0;
class Migrations1740866930911 {
    constructor() {
        this.name = 'Migrations1740866930911';
    }
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "bookings" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "frequency" character varying(50) NOT NULL, "hoursRequired" integer NOT NULL, "preferredDays" text, "preferredTimes" character varying(10), "cleaningStartDate" date, "paymentReference" character varying(100), "paymentStatus" character varying(20) NOT NULL DEFAULT 'pending', "paymentType" character varying(20) NOT NULL DEFAULT 'paystack', "needsIroning" boolean NOT NULL DEFAULT false, "accessInstructions" text, "additionalInfo" text, "referralSource" character varying(100), "title" character varying(20), "firstName" character varying(100), "lastName" character varying(100), "contactNumber" character varying(15), "email" character varying(100), "dirtLevel" character varying(50), "roomSelection" text, "additionalServices" text, "amount" numeric(10,2) NOT NULL, "status" "public"."bookings_status_enum" NOT NULL DEFAULT 'new', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "userId" uuid NOT NULL, "addressStreet" character varying(100), "addressNumber" character varying(50), "addressCity" character varying(50), "addressPostalcode" character varying(20), CONSTRAINT "PK_bee6805982cc1e248e94ce94957" PRIMARY KEY ("id"))`);
...
exports.Migrations1740866930911 = Migrations1740866930911;
